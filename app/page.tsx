      ...
      <section id="work" className="py-10 sm:py-14">
        ...
        <div className="divide-y divide-[var(--line)]">
          {projects.map((project) => (
            <article
              key={project.slug}
              className="grid gap-5 py-8 sm:grid-cols-[8rem_1fr] sm:gap-8 lg:grid-cols-[10rem_1fr_17rem]"
            >
              <div className="relative aspect-[4/3] w-full max-w-44 overflow-hidden bg-[var(--line)]">
                <Image
